...
import json, requests, shutil, time, os, base64, tempfile
...
class LineClient(LineApi, LineModels, LineTalk):
    ...
    def setRevision(self, revision):
        return self._client.revision(revision, self._client.revision)
    ...
    def findAndAddContactsByMid(self, mid):
        return self._client.findAndAddContactsByMid(0, mid, 0, '')
